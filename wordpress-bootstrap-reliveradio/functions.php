...
Redesign: http://labs.wikibyte.org
*/
...
function bones_custom_admin_footer() {
	echo '<span id="footer-thankyou">Developed by <a href="http://labs.wikibyte.org" target="_blank">Wikibyte.org</a></span> -  Michael McCouman jr.';
}
